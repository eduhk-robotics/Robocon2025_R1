...
class Motor:
    def __init__(self, MotorType, SlaveID, MasterID):
        ...
        :param SlaveID: CANID ??ID
        :param MasterID: MasterID ??ID ??????0
        """
        self.Pd = float(0)
        self.Vd = float(0)
...
class MotorControl:
    ...
    def control_delay(self, DM_Motor, kp: float, kd: float, q: float, dq: float, tau: float, delay: float):
        """
        MIT Control Mode Function with delay ????MIT?????????
        :param DM_Motor: Motor object ????
        :param kp: kp
        :param kd: kd
        :param q:  position  ????
    ...
    def set_zero_position(self, Motor):
        """
        set the zero position of the motor ????0?
        :param Motor: Motor object ????
        """
    ...
    def switchControlMode(self, Motor, ControlMode):
        ...
        :param Motor: Motor object ????
        :param ControlMode: Control_Type ?????? example:MIT:Control_Type.MIT MIT??
        """
        max_retries = 20
