...
from DM_can import *  # Import your motor control library (everything from DM_can.py)
import serial
import os
...
class MotorControllerNode(Node):
    def __init__(self):
        ...
        self.motors = [Motor(DM_Motor_Type.DM4310, i, 0x00) for i in range(1, 9)]
